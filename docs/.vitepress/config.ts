      ...
      '/notes/frontend/': [
        {
          ...
          items: [
            ...
            { text: '小程序 page-container 实现实时预览与手势返回拦截', link: '/notes/frontend/小程序page-container实现实时预览与手势返回拦截' },
            { text: 'iOS @keyframes 中 CSS 变量失效的兼容方案', link: '/notes/frontend/iOS-keyframes中CSS变量失效的兼容方案' },
            { text: 'iOS scroll-view bounces 失效问题与解决方案', link: '/notes/frontend/iOS-scroll-view-bounces失效问题与解决方案' },
            { text: '小程序全局音频管理器的单例设计', link: '/notes/frontend/小程序全局音频管理器的单例设计' },
            { text: '小程序麦克风吹气检测的实现与鸿蒙兼容', link: '/notes/frontend/小程序麦克风吹气检测的实现与鸿蒙兼容' },
            { text: '在微信小程序中实现一个 2D RPG 跑图引擎', link: '/notes/frontend/在微信小程序中实现一个2D-RPG跑图引擎' },
          ],
        },
      ],
      '/notes/ai/': [
